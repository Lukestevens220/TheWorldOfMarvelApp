...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private static final String TWITTER_KEY = "zvKRPsxDhLfkZYzPDb6oapolC";
    private static final String TWITTER_SECRET = "GXGcgicon7OCtrziesuwR3sbNQFTPxDd1ZCtUwk8p1ZjGRw1ad";
